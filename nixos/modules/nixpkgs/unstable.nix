...
in {
  options.nixpkgs.unstable = {
    ...
    pkgs = mkOption {
      ...
      defaultText = "nixpkgs-unstable instantiated for this host's platform";
      description = ''
        The nixpkgs-unstable package set, instantiated once per host.
        This is the only place the unstable input is instantiated;
        consumers reference packages as
